...
const faqs: FaqItem[] = [
  ...
  {
    category: "Модульность",
    question: "Как устроена система аддонов и модульность?",
    answer:
      "Obsy Launcher оснащен встроенным Addon Engine на базе React и TypeScript. Разработчики могут создавать аддоны, встраивающие виджеты в UI-слоты (шапка, дашборд, сайдбар, настройки, элементы запуска), подключать фоновые сервисы и перехватывать жизненный цикл игры через хук onBeforeLaunch. Аддоны собираются в компактные zip-архивы и активируются на лету.",
  },
  {
    category: "Безопасность",
    question: "Безопасно ли использовать сторонние аддоны?",
    answer:
      "Да. Каждый аддон декларирует строгий список необходимых прав доступа (permissions: ui:slots, game:launch, storage:local, network:fetch и т.д.). Лаунчер изолирует выполнение и предотвращает несанкционированные действия.",
  },
  {
    category: "Безопасность",
